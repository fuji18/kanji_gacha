...
import type { CombineEntry, Level, Part, Rarity } from './types';
import { LEVELS, LEVEL_RANK, RARITY_RATES, STUCK_RATE_BAND } from './constants';
...
const DEFAULTS = { seed: 20260602, trials: 2000, gacha: 10, handCap: 12 };
...
function prepareEntries(data: GeneratedData): PreparedEntry[] {
  ...
  return data.combine.map((e: CombineEntry) => {
